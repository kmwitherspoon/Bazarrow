...
},{"./goodsCollection":1,"./goodsModelView":4,"backbone":8,"jquery":10,"underscore":11}],3:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./goodsModel":3,"./templates":17,"backbone":8,"jquery":10,"underscore":11}],5:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
Backbone.$ = $;
var _ = require('underscore');
...
},{"backbone":8,"jquery":10,"underscore":11}],6:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
Backbone.$ = $;
var _ = require('underscore');
...
},{"./templates":17,"./userModel":20,"backbone":8,"jquery":10,"underscore":11}],7:[function(require,module,exports){
var $ = require('jquery');
var Backbone = require('backbone');
...
},{"./layoutView":5,"./router":16,"backbone":8,"jquery":10}],8:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
...
},{"./postModel":14,"backbone":8}],13:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./postCollection":12,"./postModelView":15,"backbone":8,"jquery":10,"underscore":11}],14:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":8}],15:[function(require,module,exports){
var Backbone = require('backbone');
var PostModel = require('./postModel');
var _ = require('underscore');
var $ = require('jquery');
...
},{"./postModel":14,"./templates":17,"backbone":8,"jquery":10,"underscore":11}],16:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
var _ = require('underscore');
var UserCollectionView = require('./userCollectionView');
...
},{"./goodsCollection":1,"./goodsCollectionView":2,"./layoutView":5,"./loginFormView":6,"./postCollection":12,"./postCollectionView":13,"./userCollection":18,"./userCollectionView":19,"backbone":8,"jquery":10,"underscore":11}],17:[function(require,module,exports){
module.exports = {
  header: [
    "<h1>hello world</h1>"
  ].join(""),
  ...
  userForm: [
    ...
    '<form class="loginForm" action="/login" method="post">',
      "<input class='form-control loginUsername' type='text' name='username' placeholder='Username'></input>",
      '<input type="password" class="form-control loginPassword" name="password" value="" placeholder="Password">',
      '<button type="submit" class="btn btn-secondary l-loginBtn">Login</button></a>',
      '<button type="submit" class="btn btn-secondary l-signUpBtn">Sign Up</button>',
    "</form>",
    '</div>',
...
},{"./userModel":20,"backbone":8}],19:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./userCollection":18,"./userModelView":21,"backbone":8,"jquery":10,"underscore":11}],20:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":8}],21:[function(require,module,exports){
var Backbone = require('backbone');
var UserModel = require('./userModel');
var _ = require('underscore');
var $ = require('jquery');
...
},{"./templates":17,"./userModel":20,"backbone":8,"jquery":10,"underscore":11}]},{},[7]);
